        ...
        <View style={{ gap: 16 }}>
          ...
          <Entrance index={2}><Card padded={false}>
            <View style={{ paddingHorizontal: 12 }}>
              ...
              <Divider style={{ marginVertical: 0 }} />
              {driver ? <ListItem icon="bicycle-outline" title="Beralih ke Mode Driver" onPress={async () => { await setMode('driver'); router.replace('/(driver)'); }} /> : <ListItem icon="open-outline" title="Buka aplikasi Pelanggan" subtitle="Pesan layanan sebagai pelanggan" onPress={() => openApp('pelanggan')} />}
              <Divider style={{ marginVertical: 0 }} />
