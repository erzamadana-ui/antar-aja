...
export default function Register() {
  ...
  return (
    <Screen title={t('create_account')} back maxWidth={480}>
      ...
      <Entrance index={1}><Text style={[font.h1, { marginTop: 8 }]}>{t('register')} AntarKita</Text><Text style={font.small}>{t('start_sub')}</Text></Entrance>
      <Entrance index={2}><Glass variant="strong" padded style={{ marginTop: 16 }}><View style={{ gap: 14 }}>
        ...
        <Text style={{ fontSize: 12, color: colors.textMuted, textAlign: 'center' }}>Dengan mendaftar Anda menyetujui Syarat & Ketentuan serta Kebijakan Privasi AntarKita.</Text>
