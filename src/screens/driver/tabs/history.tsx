  ...
  return (
    <Screen title="Riwayat Order" scroll={false} padded={false} ambient="amber">
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: TAB_BAR_SPACE + 16, width: '100%', maxWidth: 720, alignSelf: 'center' }} showsVerticalScrollIndicator={false}>
        {loading ? [0, 1, 2].map((i) => <View key={i} style={{ marginBottom: 12, gap: 10, padding: 14, backgroundColor: 'rgba(255,255,255,0.92)', borderRadius: 20 }}><Skeleton width="40%" height={16} /><Skeleton width="90%" height={12} /><Skeleton width="70%" height={12} /></View>)
