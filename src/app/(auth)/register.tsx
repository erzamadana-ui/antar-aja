  ...
  return (
    <Screen title="Buat Akun" back maxWidth={480}>
      ...
      <Entrance index={1}><Glass variant="strong" padded style={{ marginTop: 16 }}><View style={{ gap: 14 }}>
        ...
        <Input label="Kata sandi" icon="lock-closed-outline" value={f.password} onChangeText={set('password')} secureTextEntry placeholder="Minimal 6 karakter" />
        ...
        <Button title="Daftar" size="lg" onPress={submit} />
