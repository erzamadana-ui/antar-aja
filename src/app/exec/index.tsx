...
export default function ExecPortal() {
  ...
  if (!session) return <Screen title="Portal Eksekutif" back><Empty icon="lock-closed-outline" title="Masuk dulu" subtitle="Portal eksekutif memerlukan akun Antar Aja + PIN eksekutif." action={<Button title="Masuk" onPress={() => router.replace('/login' as never)} />} /></Screen>;
